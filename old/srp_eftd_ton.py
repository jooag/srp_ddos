...
def test_run():
    ...
    stream = FileStream('shuffled_balanced_dataset_ton.csv')
...
#####################################
    ...
    with open('model_srp_ton.pickle', 'wb') as f:
        pickle.dump(srp, f)
    ################## MÉTRICAS DO MODELO #####################
    ...
    plt.savefig("srp_acc_eftd_ton.pdf")
    plt.clf()
    plt.plot(times, precisions)
    plt.savefig("srp_p_eftd_ton.pdf")
    plt.clf()
    plt.plot(times, recalls)
    plt.savefig("srp_r_eftd_ton.pdf")
    plt.clf()
    plt.plot(times, f1s)
    plt.savefig("srp_f1_eftd_ton.pdf")
    plt.clf()
    ...
    # stream = FileStream('shuffled_imbalanced_dataset_ton.csv')
